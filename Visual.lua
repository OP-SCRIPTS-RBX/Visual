...
OrionLib:MakeNotification({
    Name = "OPSCRIPTS Script | MM2",
    Content = "OPSCRIPTS Script: Murder Mystery 2",
    Image = "rbxassetid://7733964719",
    Time = 5
})

local Window = OrionLib:MakeWindow({
    Name = "OPSCRIPTS Script GUI",
    HidePremium = false,
    IntroText = "OPHUBV5",
    SaveConfig = true,
    ConfigFolder = "OPSRIPTS_Config"
})
...
InfoTab:AddParagraph("MM2 Dupe Status!", "The MM2 Dupe Is Currenty 100% Working.")
InfoTab:AddLabel("Script Hub Made By OPSCRIPTS!")
InfoTab:AddButton({
    Name = "Copy Discord Invite",
    Callback = function()
        setclipboard("discord.gg/2PNX4UQsmT")
        OrionLib:MakeNotification({
            Name = "OPHUB | Made by OPSCRIPTS",
...
DupeTab:AddButton({
    ...
    Callback = function()
        ...
        OrionLib:MakeNotification({
            Name = "OPHUB | MM2",
            Content = "Successfully Duplicated Whole Weapon Inventory!",
            Image = "rbxassetid://7733964719",
            Time = 5
        })
    end    
...
DupeTab:AddParagraph("Tutorial For Weapon Duper!", "Enter the weapon, set amount, click start.")
...
AutoFarmTab:AddParagraph("Note For AutoFarm!", "Newest auto farm script.")
...
ChangerTab:AddParagraph("Tutorial For Weapon Spawner!", "Enter weapon → choose new one → reset.")
...
ChangelogsTab:AddParagraph("Credits", "Created by OPHUB, developed by OPSCRIPTS")
